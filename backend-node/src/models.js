...
const taskSchema = new Schema({
  ...
  classificationLevel: { type: String, required: true, default: "RESTRICTED" },
  distribution: { type: String, required: true, default: "Authorized NTRO personnel" },
  inputHash: { type: String, required: true },
  inputPreview: { type: String, required: true, maxlength: 1000 },
  outputTypes: { type: [String], required: true },
  operation: { type: String, enum: ["create", "revise"], default: "create" },
  parentRunId: { type: String, default: "", maxlength: 200 },
  parentArtifactId: { type: String, default: "", maxlength: 300 },
  revisionInstruction: { type: String, default: "", maxlength: 4000 },
  revisionScope: { type: [String], default: [] },
  status: { type: String, required: true, default: "queued", index: true },
  result: { type: Schema.Types.Mixed, default: null },
  runSummary: { type: Schema.Types.Mixed, default: null },
  eventSequence: { type: Number, default: 0, min: 0 },
  artifactManifests: { type: [Schema.Types.Mixed], default: [] },
