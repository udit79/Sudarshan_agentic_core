...
export function ConversationRoot({ sessionId, useSession, useSessions, useSessionPendingInteraction, useWorkspaces, useConversation, useInput, useComposerBlock, renderSlot, renderSlotChain, createSession, selectWorkspace, t, }) {
    ...
    const composerBar = (_jsxs("div", { className: clsx(css.composerStack, hero && css.composerHero), children: [hero && _jsx(HeroShell, { t: t, renderSlot: renderSlot }), hero && heroWorkspaceRow, hero && renderSlot('conversation.hero.caseDocuments', {
                sessionId,
                createSession: () => createSession(),
            }), zone !== undefined && renderSlot('conversation.input.dock', zone), inputBar] }));
